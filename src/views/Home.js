...
export default function Home({ user, books }) {
  ...
  <>
    <div>
      {user && <div>
      <div className="lg:w-1/3 h-24 w-full m-4 bg-medblue mx-auto shadow-lg rounded-tl-lg rounded-tr-lg rounded-br-lg">
        <h4 className="text-center pt-4 lg:p-9">Welcome home, {user.fullName}</h4>
      </div>
